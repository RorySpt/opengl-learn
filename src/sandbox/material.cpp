...
MaterialTable::MaterialTable()
{
	...
	insert_or_assign("»Æ½ð", Materials::gold);          // »Æ½ð
	...
	insert_or_assign("ºÚÉ«ÏðÆ¤", Materials::black_rubber);  // ºÚÉ«ÏðÆ¤
	insert_or_assign("ÇàÉ«ÏðÆ¤", Materials::cyan_rubber);   // ÇàÉ«ÏðÆ¤
	insert_or_assign("ÂÌÉ«ÏðÆ¤", Materials::green_rubber);  // ÂÌÉ«ÏðÆ¤
	insert_or_assign("ºìÉ«ÏðÆ¤", Materials::red_rubber);    // ºìÉ«ÏðÆ¤
	insert_or_assign("°×É«ÏðÆ¤", Materials::white_rubber);  // °×É«ÏðÆ¤
	insert_or_assign("»ÆÉ«ÏðÆ¤", Materials::yellow_rubber); // »ÆÉ«ÏðÆ¤
