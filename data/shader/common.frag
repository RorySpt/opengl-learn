...
void main()
{
	...
	materialVal.ambient  = vec3(texture(material.diffuseTex,  TexCoords)) + material.diffuse;
	materialVal.diffuse  = vec3(texture(material.diffuseTex,  TexCoords)) + material.diffuse;
	materialVal.specular = vec3(texture(material.specularTex, TexCoords)) + material.specular;
	materialVal.emission = vec3(texture(material.emissionTex, TexCoords)) + material.emission;
